...
(** {2 Error Causes}
    ...
    fall-back, e.g.
    {@ocaml skip[
      (match Caqti.Error.cause error with
...
val encode_missing :
  uri: Uri.t -> field_type: 'a Template.Field_type.t -> unit ->
...
val encode_rejected :
  uri: Uri.t -> typ: 'a Template.Row_type.t -> msg ->
  [> `Encode_rejected of coding_error]
...
val decode_rejected : uri: Uri.t -> typ: 'a Template.Row_type.t -> msg ->
  [> `Decode_rejected of coding_error]
