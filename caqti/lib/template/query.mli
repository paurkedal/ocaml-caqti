...
module Infix : sig
  (** This module is experimental; usage is not recommended at this point. *)
(*
  (** This module provides a terser way to compose queries.  As an example,
      ...
      {[
        ...
        type cond =
          | Column_eq : string * 'a Caqti.Template.Field_type.t * 'a -> cond
...
*)
  ...
  val (++^) : t -> string -> t [@@alert caqti_unstable]
...
(** A variant of [angstrom_parser] which accepts unquoted semicolons as part of
    ...
    definitions.  This is the parser used by {!Caqti.Template.Request}, where
