...
val linear_param_length : Caqti_request.template -> int
(** [linear_param_length templ] is the number of linear parameters expected by a
    query represented by [templ]. *)

val linear_param_order : Caqti_request.template -> int list list
...
val linear_query_string : Caqti_request.template -> string
